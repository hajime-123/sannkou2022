...
![1](ubuntu_flask設定画像6/1.PNG)

if __name__ == '__main__':をつけることでインポートしただけならfunc1は実行されない

この書き方をすることで個別のテスト用に利用できる

またhello.pyでインポートしたライブラリも使用できるようになる。
...
![1](ubuntu_flask設定画像6/2.PNG)

以上を参考にmat_log_main.pyからmat_log05.py、mat_log10.py、mat_log600.py
